...
- **REMAINING:** diagnose+fix ecb-mcp boot crash → embeddings deploy · crm-dashboard creds (Levi) + verify · backfill demotions (Levi) · close handoff snapshot · handhold prompt for Levi (crm creds).
